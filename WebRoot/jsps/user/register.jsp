...
<body class="sc reg">
				...
				<tbody>
					<tr>
						<td><img class="logo_osc"
							src="jsps/user/pic/logo_osc.png" "="" alt="开源中国"></td>
					</tr>
					<tr>
	...
	<title>注册 - 开源中国社区</title>

	<link type="text/css" rel="stylesheet"
		href="./css/login-main-039747cacbd4818e53205f1c5623cc4069967dee.css">


	<x-foo-define data-define="www_logon"></x-foo-define>
	<val data-name="captcha" data-value="/action/user/captcha?t="></val>
	<val data-name="quick_create" data-value="/action/user/quick_create"></val>
	<val data-name="sendVerifyCodeForRegister"
		data-value="/action/user/sendVerifyCodeForRegister"></val>
	<val data-name="sendEmailVerifyCode"
		data-value="/action/user/mail_code"></val>
	<val data-name="successRegister"
		data-value="regok?goto_page=https://www.oschina.net/question"></val>
	...
	<div class="logon-body">
		<div class="box logon-form">
			<div class="box-aw">
				...
				<div class="phone-logon tab-box" id="phone_logon"
					style="padding-top: 5px;">
					<div class="logon-form form-wrapper">
						<input class="hide" name="from" id="from" value="">
						<div class="form-item">
							<div class="form-ctrl">
								<input type="text" maxlength="11" name="phoneNum" id="phoneNum"
									placeholder="请输入手机号码" title="手机号码">
							</div>
							<div class="form-tips"></div>
						</div>
						<div class="form-item">
							<div class="form-ctrl">
								<input type="text" id="mail" name="mail" placeholder="请输入邮箱地址"
									title="邮箱地址">
							</div>
							<div class="form-tips"></div>
						</div>
						<div class="form-item">
							<div class="form-ctrl">
								<input type="text" id="username" name="username" maxlength="20"
									placeholder="请输入用户名，至少2个字符，至多20个" title="昵称，至少2个字符，至多20个字符">
							</div>
							<span class="spanDiv" id="spanDiv"></span>
							<span><s:fielderror><s:param>username</s:param></s:fielderror></span>
							<div class="form-tips"></div>
						</div>
						<div class="form-item">
							<div class="form-ctrl">
								<input type="password" id="password" name="password"
									placeholder="请输入密码，字母或特殊符号和数字结合" title="密码，字母或特殊符号和数字结合">
							</div>
						...
						<div class="form-item">
							<div class="form-ctrl">
								...
								placeholder="请再次输入密码" 	title="请再次输入密码">
							</div>
							<span class="spanPwd2" id="spanPwd2"></span>
							<span><s:fielderror><s:param>repassword</s:param></s:fielderror></span>
							<div class="form-tips"></div>
						</div>
						<!-- <div class="form-item box">
							<div class="form-ctrl box-aw">
								<input type="text" id="vCode" placeholder="四位验证码" title="四位验证码">
							</div>
							<div class="box form-v-code box-fr vertical">
								<span class="v-code-img box-aw box"> <img id="img_vcode"
									align="absmiddle" alt="..." src="jsps/user/js/captcha">
								</span>
							</div>
							<div class="form-tips"></div>
						</div>
						<div class="form-item box">
							<div class="from-ctrl box-aw">
								<input type="text" id="phoneVcode" placeholder="请输入短信验证码"
									title="短信验证码">
							</div>
							<span class="form-phone-code box-fr" title="点击切换验证码"> <input
								type="button" value="获取验证码"
								class="btn btn-green box vertical send-phone-vcode">
							</span>
							<div class="form-tips"></div>
						</div>
						...
						<div class="form-item box">
							...
							<span class="form-phone-code box-fr"> <input type="button"
								value="获取验证码"
								class="btn btn-green box vertical send-email-vcode">
							</span>
							<div class="form-tips"></div>
						</div> -->
						<div class="form-item">
							<div class="box user-gender">
								<div class="checkbox-group box-aw">
									<input type="radio" id="phone-male" checked="checked" value="男"
										name="sex"> <label for="phone-male">
										<i class="ic-svg ic-male"></i> 男士
									</label>
								</div>
								<div class="checkbox-group box-aw">
									<input type="radio" id="phone-female" name="sex" value="女">
									<label for="phone-female"> <i class="ic-svg ic-female"></i>
										女士
									</label>
								</div>
							</div>
						...
						<div class="form-item">
							<div class="form-ctrl osc-checkbox-accept-term">
								<input id="accept_term_phone" name="accept_term_phone"
									type="checkbox" value="1" tabindex="0" class="accept_term">
								<label for="accept_term_phone">已阅读并同意<a
									href="https://www.oschina.net/terms" target="_blank">服务条款</a></label>
							</div>
							<div class="form-tips"></div>
						</div>

						<div class="form-button form-item">
							<button type="submit" id="submit" class="btn btn-green block btn-logon">
								注册</button>
							<div class="form-tips"></div>
						</div>
					</div>
			...
			<div class="box-fr other-login-wrapper">
				<span class="span-box"> 已经注册过? </span> <a
					href="<c:url value='/jsps/user/login.jsp'></c:url>"
					class="btn btn-link btn-lg btn-login margin-forty"> 直接登录 → </a>
	...
	<!-- Generated by OsChina.NET (init:0[ms],page:4[ms],ip:183.30.124.147) -->
	
</body>
<style type="text/css" id="31516432453"></style>
</html>