(function() {
	...
	mt.cookie.set = function(a, b, d) {
		...
		document.cookie = a + "=" + b + (d.domain ? "; domain=" + d.domain : "") + (d.path ? "; path=" + d.path : "") + (g ? "; expires=" + g.toGMTString() : "") + (d.xb ? "; secure" : "")
	};
	...
	mt.i.Ha = function(a) {
		return (a = mt.i.Q(a, t)) && a.length ? String(a[0]) : ""
	};
	mt.i.rb = function(a) {
		return mt.i.Q(a, v)
	};
	...
	mt.i.Fa = function(a) {
		...
		"undefined" !== typeof a.getBoundingClientRect && (b = a.getBoundingClientRect());return {
	...
	(mt.i.Za = function() {
		...
		document.addEventListener ? f = function() {
			document.removeEventListener("DOMContentLoaded", f, v);a()
	...
	(function() {
		...
		mt.f.ab = (window.screen.width || 0) + "x" + (window.screen.height || 0);
		...
		mt.f.orientation = 0;(function() {
			function b() {
				var a = 0;
				window.orientation !== s && (a = window.orientation);screen && (screen.orientation && screen.orientation.angle !== s) && (a = screen.orientation.angle);
				mt.f.orientation = a
			}
	...
	mt.l.stringify = function() {
		...
		return function(d) {
			...
			default:
				...
				l = [ "{" ];n = mt.l.stringify;
				for (p in d)
					if (Object.prototype.hasOwnProperty.call(d, p)) switch (e = d[p], typeof e) {
						case "undefined":
						case "unknown":
						case "function":
							break;default:
	...
	var A = h.xa;
	h.s = {
		ub : "http://tongji.baidu.com/hm-web/welcome/ico",
	...
	(function() {
		function a(a, g) {
			...
			f.src = a;var p = document.getElementsByTagName("script")[0];
	...
	(function() {
			...
			n = {
				...
				oa : function() {
					return function(a) {
						a = n.Aa(a);
						if ("" !== a) {
							var d = (f.H + "//" + f.U + "?" + h.b.da().replace(/ep=[^&]*/, "ep=" + encodeURIComponent(a))).length;
							d + (f.z + "").length > f.Y || (d + encodeURIComponent(l.join("!") + (l.length ? "!" : "")).length + (f.z + "").length > f.Y && n.I(), l.push(a), (l.length >= f.ra || /\*a\*/.test(a)) && n.I())
						}
					}
				},
				Aa : function(k) {
					...
					e = [];e.push(m);
					e.push(q);e.push(k.Va);e.push(k.Wa);e.push(k.Ya);e.push(b.g(k.Xa));e.push(k.pb);e.push(k.Ka);
					(d = "a" === (d.tagName || "").toLowerCase() ? d : a.za(d)) ? (e.push("a"), e.push(b.g(encodeURIComponent(d.href)))) : e.push("b");return e.join("*")
				},
				Ea : function(k, d, m, q) {
					k = a.Ha(d);
					var e = 0,
		...
		p.c("pv-b", n.ga);p.c("pv-b", e.ia);return n
	})();
	(function() {
		function a() {
			return function() {
				...
				h.b.a.st = 4;
				h.b.a.et = 3;
				h.b.a.ep = h.M.Ga() + "," + h.M.Ca();h.b.j()
			}
		}
		function b() {
			clearTimeout(z);var a;
			r && (a = "visible" == document[r]);y && (a = !document[y]);
	...
	(function() {
		function a(a, d, m, b) {
			if (!(a === s || d === s || b === s)) {
				...
				r || a.push([ d, m, b ].join("*"));return a.join("!")
			}
		}
		function b(a) {
			for (var e in a)
		...
		var d = mt.lang,
			...
			e = {
				...
				wa : function() {
					if (0 < e.w.length)
						for (var a = 0, d = e.w.length; a < d; a++) e.T(e.w[a]);
					e.w = u
				},
				T : function(a) {
					var b = a[0];
				...
				_trackPageview : function(a) {
					if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
						...
						var d = h.b.a.u,
							m = h.b.a.su;
						h.b.a.u = p.protocol + "//" + document.location.host + a[1];e.ba || (h.b.a.su = document.location.href);h.b.j();
						h.b.a.u = d;
						h.b.a.su = m
					}
				},
				_trackEvent : function(a) {
					2 < a.length && (e.e |= 8, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 4, h.b.a.ep = d.g(a[1]) + "*" + d.g(a[2]) + (a[3] ? "*" + d.g(a[3]) : "") + (a[4] ? "*" + d.g(a[4]) : ""), h.b.j())
				},
				...
				_trackOrder : function(a) {
					a = a[1];d.d(a, "Object") && (b(a), e.e |= 16, h.b.a.nv = 0, h.b.a.st = 4, h.b.a.et = 94, h.b.a.ep = g.stringify(a), h.b.j())
				},
				...
				_trackRTEvent : function(a) {
					...
					if (d.d(a, "Object")) {
						...
						var f = function(a) {
							...
							m = a.length;
						if (900 >= m) f.call(this, a);else
							for (var m = Math.ceil(m / 900), q = "block|" + Math.round(Math.random() * p.z).toString(16) + "|" + m + "|", l = [], r = 0; r < m; r++) l.push(r), l.push(a.substring(900 * r, 900 * r + 900)), f.call(this, q + l.join("|")), l = []
					}
				},
	...
	(function() {
		function a() {
			"undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = t, this.a = {}, this.$ = t, this.R = v, this.init())
		}
		var b = mt.url,
			d = mt.ea,
			g = mt.W,
		...
		a.prototype = {
			...
			O : function() {
				for (var a = document.location.hostname, b = 0, d = c.dm.length; b < d; b++)
					if (this.S(a, c.dm[b])) return c.dm[b].replace(/(:\d+)?[\/\?#].*/, "");
				return a
			},
			Z : function() {
			...
			Ia : function() {
				...
				var a = v;
				this.F(document.referrer) && this.F(document.location.href) ? a = t : (a = b.P(document.referrer), a = this.S(a || "", document.location.hostname));return a ? k.m - k.r > c.vdur ? 1 : 4 : 3
			},
			getData : function(a) {
				try {
			...
			da : function() {
				...
				switch (b) {
				case 0:
					a.push("sn=" + k.L);this.a.rt && a.push("rt=" + encodeURIComponent(this.a.rt));
					break;case 3:
					a.push("sn=" + k.L);
					break;case 85:
					a.push("sn=" +
			...
			hb : function() {
				...
				this.a.cm = b.k(a, k.Oa) || "";
				this.a.cp = b.k(a, k.Pa) || b.k(a, k.mb) || "";
				this.a.cw = b.k(a, k.Na) || b.k(a, k.ob) || "";
				this.a.ci = b.k(a, k.La) || b.k(a, k.lb) || "";
				this.a.cf = b.k(a, k.Qa) || b.k(a, k.nb) || "";
				this.a.cu = b.k(a, k.Ma) || b.k(a, k.jb) || ""
			},
			init : function() {
				try {
					this.hb(), 0 === this.a.nv ? this.fb() : this.V(".*"), h.b = this, this.na(), w.A("pv-b"), this.eb()
				} catch (a) {
					var b = [];
					b.push("si=" + c.id);b.push("n=" + encodeURIComponent(a.name));b.push("m=" + encodeURIComponent(a.message));b.push("r=" + encodeURIComponent(document.referrer));
			...
			eb : function() {
				...
				this.$ ? (this.R = t, this.a.et = 0, this.a.ep = "", this.a.vl = l.C() + l.D(), this.j(a)) : a()
			},
			j : function(a) {
				var b = this;
				b.a.rnd = Math.round(Math.random() * k.z);w.A("stag-b");
				var e = k.H + "//" + k.U + "?" + b.da();
				w.A("stag-d");b.ka(e);d.log(e, function(d) {
					b.V(d);f.d(a, "Function") && a.call(b)
				})
			},
			na : function() {
				var a = document.location.hash.substring(1),
					d = RegExp(c.id),
					e = b.P(document.referrer) === k.la ? 1 : 0,
					f = b.k(a, "jn"),
					l = /^heatlink$|^select$|^pageclick$/.test(f);
				a && (d.test(a) && e && l) && (this.a.rnd = Math.round(Math.random() * k.z), a = document.createElement("script"), a.setAttribute("type", "text/javascript"), a.setAttribute("charset", "utf-8"), a.setAttribute("src", k.protocol + "//" + c.js + f + ".js?" + this.a.rnd), f = document.getElementsByTagName("script")[0], f.parentNode.insertBefore(a, f))
			},
			ka : function(a) {
	...
	(function() {
		...
		if (c.kbtrk && "undefined" !== typeof h.b) {
			h.b.a.kb = b.Ta() ? h.b.a.kb : 0;
			var g = function() {
				h.b.a.et = 85;
				h.b.a.ep = h.b.a.kb;h.b.j()
			};
